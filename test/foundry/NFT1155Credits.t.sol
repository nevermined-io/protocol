...
contract NFT1155CreditsTest is Test {
  ...
  function setUp() public {
    ...
    nft1155.initialize(address(nvmConfig), address(assetsRegistry), "NFT1155Credits", "NFT1155Credits");
  }
  ...
  function _createPlan() internal returns (bytes32) {
    ...
    (uint256[] memory amounts, address[] memory receivers) = assetsRegistry.addFeesToPaymentsDistribution(_amounts, _receivers);
