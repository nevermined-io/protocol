...
contract AssetsRegistryTest is BaseTest {
    ...
    function test_setDefaultFeeController() public {
        ...
        vm.prank(governor);
        assetsRegistry.setDefaultFeeController(IFeeController(newFeeController));

        // Verify the default fee controller was updated
        assertEq(address(assetsRegistry.getDefaultFeeController()), newFeeController);
    }
    ...
    function test_getDefaultFeeController() public view {
        ...
        IFeeController currentFeeController = assetsRegistry.getDefaultFeeController();
