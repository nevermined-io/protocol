...
contract AgreementsStoreTest is BaseTest {
    ...
    function test_onlyTemplatesCanRegisterAgreements() public {
        ...
        agreementsStore.register(testAgreementId, address(this), 0, conditionIds, conditionStates, params);
    }
    ...
    function test_areConditionsFulfilled_returnsFalseWhenConditionAlreadyFulfilled() public {
        ...
        vm.prank(template);
        agreementsStore.register(agreementId, user, 1, conditionIds, conditionStates, new bytes[](0));
